...
<head>
  ...
  <title>eazyntt</title>
  <link rel="shortcut icon" type="image/png" href="assets/Logo-cut.png" />
      ...
      <div>
        <div class="brand-logo d-flex align-items-center justify-content-between">
          <a href="./index.html" class="text-nowrap logo-img">
            <img src="assets/Logo1-eazyn.png" width="180" alt="" />
          </a>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./ui-buat_izin.html" aria-expanded="false">
                <span>
                      ...
                      $fetch_data = mysqli_fetch_all($run_sql, MYSQLI_BOTH);
                        ...
                        <tr>
                          <td class="border-bottom-0">
                            <h6 class="fw-semibold mb-0"><?php echo $data["id"]?></h6>
                          </td>
                          <td class="border-bottom-0">
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="card overflow-hidden">
                  <div class="card-body p-4">
                    <h5 class="card-title mb-9 fw-semibold">Sisa Izin</h5>
                    <div class="row align-items-center">
                      <div class="col-8">
                        <?php
                        $query1 = "select value from settings where nama_settings = 'pembatasan'";
                        $query2 = "select count(id) as jumlah_izin from izin where siswa_id = 5 and is_approved = 2";
                        ...
                        foreach($fetch_data1 as $data1){
                          echo $data1['value'];
                        // }
                        // $fetch_data2 = mysqli_fetch_all($sql1);
                        // //kalau bertipw array di var_dump
                        // foreach($fetch_data2 as $data2){
                        //   echo $data2 ['jumlah_izin']
                        }
                        ?>
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="card w-100">
              <!-- <div class="card-body p-4">
                <div class="mb-4">
                  <h5 class="card-title fw-semibold">Alur Pengajuan Izin</h5>
                </div>
